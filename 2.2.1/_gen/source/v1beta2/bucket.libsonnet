{
  ...
  '#spec':: d.obj(help='"BucketSpec specifies the required configuration to produce an Artifact for an object storage bucket."'),
  spec: {
    ...
    '#secretRef':: d.obj(help='"SecretRef specifies the Secret containing authentication credentials for the Bucket."'),
    secretRef: {
    ...
    '#withInterval':: d.fn(help='"Interval at which the Bucket Endpoint is checked for updates. This interval is approximate and may be subject to jitter to ensure efficient use of resources."', args=[d.arg(name='interval', type=d.T.string)]),
    ...
    '#withProvider':: d.fn(help="\"Provider of the object storage bucket. Defaults to 'generic', which expects an S3 (API) compatible object storage.\"", args=[d.arg(name='provider', type=d.T.string)]),
    ...
    '#withSuspend':: d.fn(help='"Suspend tells the controller to suspend the reconciliation of this Bucket."', args=[d.arg(name='suspend', type=d.T.boolean)]),
