  ...
  spec: {
    ...
    git: {
      ...
      push: {
        ...
        '#withOptions':: d.fn(help='"Options specifies the push options that are sent to the Git server when performing a push operation. For details, see: https://git-scm.com/docs/git-push#Documentation/git-push.txt---push-optionltoptiongt"', args=[d.arg(name='options', type=d.T.object)]),
        withOptions(options): { spec+: { git+: { push+: { options: options } } } },
        '#withOptionsMixin':: d.fn(help='"Options specifies the push options that are sent to the Git server when performing a push operation. For details, see: https://git-scm.com/docs/git-push#Documentation/git-push.txt---push-optionltoptiongt"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='options', type=d.T.object)]),
        withOptionsMixin(options): { spec+: { git+: { push+: { options+: options } } } },
        '#withRefspec':: d.fn(help='"Refspec specifies the Git Refspec to use for a push operation. If both Branch and Refspec are provided, then the commit is pushed to the branch and also using the specified refspec. For more details about Git Refspecs, see: https://git-scm.com/book/en/v2/Git-Internals-The-Refspec"', args=[d.arg(name='refspec', type=d.T.string)]),
