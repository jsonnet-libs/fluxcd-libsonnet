{
  ...
  spec: {
    '#commonMetadata':: d.obj(help='"CommonMetadata specifies the common labels and annotations that are applied to all resources.\\nAny existing label or annotation will be overridden if its key matches a common one."'),
    commonMetadata: {
    ...
    '#withWait':: d.fn(help='"Wait instructs the controller to check the health of all the reconciled resources.\\nWhen enabled, the HealthChecks are ignored. Defaults to false."', args=[d.arg(name='wait', type=d.T.boolean)]),
