---
permalink: /2.6.1/source/v1/gitRepository/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withSparseCheckout(sparseCheckout)`](#fn-specwithsparsecheckout)
  * [`fn withSparseCheckoutMixin(sparseCheckout)`](#fn-specwithsparsecheckoutmixin)
...
### fn spec.withSparseCheckout

```ts
withSparseCheckout(sparseCheckout)
```
...
### fn spec.withSparseCheckoutMixin

```ts
withSparseCheckoutMixin(sparseCheckout)
```
