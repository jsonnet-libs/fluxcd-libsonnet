---
permalink: /2.9.4/source/v1/ociRepository/
---

# source.v1.ociRepository
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.ref`](#obj-specref)
    ...
    * [`fn withSemverFilter(semverFilter)`](#fn-specrefwithsemverfilter)
  ...
  * [`obj spec.verify`](#obj-specverify)
    ...
    * [`obj spec.verify.trustedRootSecretRef`](#obj-specverifytrustedrootsecretref)
      * [`fn withName(name)`](#fn-specverifytrustedrootsecretrefwithname)
...
### fn spec.ref.withSemverFilter

```ts
withSemverFilter(semverFilter)
```
...
## obj spec.verify.trustedRootSecretRef
...
### fn spec.verify.trustedRootSecretRef.withName
