---
permalink: /2.9.4/image/v1/imageUpdateAutomation/
---

# image.v1.imageUpdateAutomation
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.git`](#obj-specgit)
    ...
    * [`obj spec.git.commit`](#obj-specgitcommit)
      ...
      * [`fn withMessageTemplateValues(messageTemplateValues)`](#fn-specgitcommitwithmessagetemplatevalues)
      * [`fn withMessageTemplateValuesMixin(messageTemplateValues)`](#fn-specgitcommitwithmessagetemplatevaluesmixin)
      ...
      * [`obj spec.git.commit.signingKey`](#obj-specgitcommitsigningkey)
        * [`fn withType(type)`](#fn-specgitcommitsigningkeywithtype)
  ...
  * [`obj spec.policySelector`](#obj-specpolicyselector)
    ...
    * [`fn withMatchLabels(matchLabels)`](#fn-specpolicyselectorwithmatchlabels)
...
### fn spec.git.commit.withMessageTemplateValues

```ts
withMessageTemplateValues(messageTemplateValues)
```

"MessageTemplateValues provides additional values to be available to the\ntemplating rendering."

### fn spec.git.commit.withMessageTemplateValuesMixin

```ts
withMessageTemplateValuesMixin(messageTemplateValues)
```
...
### fn spec.git.commit.signingKey.withType
...
### fn spec.policySelector.withMatchLabelsMixin
