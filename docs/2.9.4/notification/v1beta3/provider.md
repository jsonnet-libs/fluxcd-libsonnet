---
permalink: /2.9.4/notification/v1beta3/provider/
---

# notification.v1beta3.provider
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withCommitStatusExpr(commitStatusExpr)`](#fn-specwithcommitstatusexpr)
...
### fn spec.withCommitStatusExpr

```ts
withCommitStatusExpr(commitStatusExpr)
```
