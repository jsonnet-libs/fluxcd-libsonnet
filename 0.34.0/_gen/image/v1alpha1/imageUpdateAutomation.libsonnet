{
  ...
  spec: {
    '#checkout':: d.obj(help='"Checkout gives the parameters for cloning the git repository, ready to make changes."'),
    checkout: {
      '#gitRepositoryRef':: d.obj(help='"GitRepositoryRef refers to the resource giving access details to a git repository to update files in."'),
      gitRepositoryRef: {
        '#withName':: d.fn(help='"Name of the referent."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { checkout+: { gitRepositoryRef+: { name: name } } } },
      },
      '#withBranch':: d.fn(help='"Branch gives the branch to clone from the git repository. If `.spec.push` is not supplied, commits will also be pushed to this branch."', args=[d.arg(name='branch', type=d.T.string)]),
      withBranch(branch): { spec+: { checkout+: { branch: branch } } },
    },
    ...
    commit: {
      ...
      signingKey: {
        ...
        secretRef: {
          '#withName':: d.fn(help='"Name of the referent."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { commit+: { signingKey+: { secretRef+: { name: name } } } } },
        },
      },
      '#withAuthorEmail':: d.fn(help='"AuthorEmail gives the email to provide when making a commit"', args=[d.arg(name='authorEmail', type=d.T.string)]),
      withAuthorEmail(authorEmail): { spec+: { commit+: { authorEmail: authorEmail } } },
      '#withAuthorName':: d.fn(help='"AuthorName gives the name to provide when making a commit"', args=[d.arg(name='authorName', type=d.T.string)]),
      withAuthorName(authorName): { spec+: { commit+: { authorName: authorName } } },
      ...
      withMessageTemplate(messageTemplate): { spec+: { commit+: { messageTemplate: messageTemplate } } },
    },
    '#push':: d.obj(help='"Push specifies how and where to push commits made by the automation. If missing, commits are pushed (back) to `.spec.checkout.branch`."'),
    push: {
      ...
      withBranch(branch): { spec+: { push+: { branch: branch } } },
    },
