{
  ...
  spec: {
    ...
    '#layerSelector':: d.obj(help='"LayerSelector specifies which layer should be extracted from the OCI artifact.\\nWhen not specified, the first layer found in the artifact is selected."'),
    layerSelector: {
      '#withMediaType':: d.fn(help='"MediaType specifies the OCI media type of the layer\\nwhich should be extracted from the OCI Artifact. The\\nfirst layer matching this type is selected."', args=[d.arg(name='mediaType', type=d.T.string)]),
      withMediaType(mediaType): { spec+: { layerSelector+: { mediaType: mediaType } } },
      '#withOperation':: d.fn(help="\"Operation specifies how the selected layer should be processed.\\nBy default, the layer compressed content is extracted to storage.\\nWhen the operation is set to 'copy', the layer compressed content\\nis persisted to storage as it is.\"", args=[d.arg(name='operation', type=d.T.string)]),
    ...
    '#ref':: d.obj(help='"The OCI reference to pull and monitor for changes,\\ndefaults to the latest tag."'),
    ref: {
      '#withDigest':: d.fn(help="\"Digest is the image digest to pull, takes precedence over SemVer.\\nThe value should be in the format 'sha256:\u003cHASH\u003e'.\"", args=[d.arg(name='digest', type=d.T.string)]),
      withDigest(digest): { spec+: { ref+: { digest: digest } } },
      '#withSemver':: d.fn(help='"SemVer is the range of tags to pull selecting the latest within\\nthe range, takes precedence over Tag."', args=[d.arg(name='semver', type=d.T.string)]),
      withSemver(semver): { spec+: { ref+: { semver: semver } } },
      '#withSemverFilter':: d.fn(help='"SemverFilter is a regex pattern to filter the tags within the SemVer range."', args=[d.arg(name='semverFilter', type=d.T.string)]),
      withSemverFilter(semverFilter): { spec+: { ref+: { semverFilter: semverFilter } } },
    ...
    '#secretRef':: d.obj(help='"SecretRef contains the secret name containing the registry login\\ncredentials to resolve image metadata.\\nThe secret must be of type kubernetes.io/dockerconfigjson."'),
    secretRef: {
      '#withName':: d.fn(help='"Name of the referent."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#withUrl':: d.fn(help='"URL is a reference to an OCI artifact repository hosted\\non a remote container registry."', args=[d.arg(name='url', type=d.T.string)]),
