{
  ...
  '#':: d.pkg(name='externalArtifact', url='', help='"ExternalArtifact is the Schema for the external artifacts API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ExternalArtifact', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'source.toolkit.fluxcd.io/v1',
    kind: 'ExternalArtifact',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ExternalArtifactSpec defines the desired state of ExternalArtifact"'),
  spec: {
    '#sourceRef':: d.obj(help='"SourceRef points to the Kubernetes custom resource for\\nwhich the artifact is generated."'),
    sourceRef: {
