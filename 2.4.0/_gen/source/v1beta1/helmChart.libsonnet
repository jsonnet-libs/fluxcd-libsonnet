{
  ...
  spec: {
    ...
    '#withVersion':: d.fn(help='"The chart version semver expression, ignored for charts from GitRepository\\nand Bucket sources. Defaults to latest when omitted."', args=[d.arg(name='version', type=d.T.string)]),
